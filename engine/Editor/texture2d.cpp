...
void Texture2D::createFromData(BYTE* bData, int a_iWidth, int a_iHeight, int a_iBPP, GLenum format, bool bGenerateMipMaps)
{
...
bool Texture2D::loadTexture2D(std::string a_sPath, bool bGenerateMipMaps)
{
...
void Texture2D::setSamplerParameter(GLenum parameter, GLenum value)
{
...
void Texture2D::setFiltering(int a_tfMagnification, int a_tfMinification)
{
...
void Texture2D::bindTexture(int iTextureUnit)
{
...
int Texture2D::getMinificationFilter()
{
	return tfMinification;
}

int Texture2D::getMagnificationFilter()
{
